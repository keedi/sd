...
run_output_matches( 'sd', [ 'list', 'ticket', '--regex', '.' ],
    [qr/(\d+) YATTA new/] );

# test claim
run_output_matches(
    'sd',
    [ 'ticket', 'claim', $yatta_id ],
...
run_output_matches(
    'sd',
    [ 'ticket', 'update', $yatta_id, '--', 'status', 'new' ],
    ["Ticket $yatta_id ($yatta_uuid) updated."]
);
...
run_output_matches(
    'sd',
    [ 'ticket', 'give', $yatta_id, 'jesse@bestpractical.com' ],
    ["Ticket $yatta_id ($yatta_uuid) updated."]
);
...
run_output_matches(
    'sd',
    [ 'ticket', 'assign', $yatta_id, 'spang@bestpractical.com' ],
    ["Ticket $yatta_id ($yatta_uuid) updated."]
);
...
require App::SD;
run_output_matches( 'sd', ['-V'], ["sd $App::SD::VERSION"], 'version short' );
